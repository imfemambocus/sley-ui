...
The reader has the same say over the shape of it. A column moves by dragging its head and resizes by dragging its edge, and if you want any of that to outlive a reload you can hold the sort, the widths and the order yourself rather than leaving them to the table.
